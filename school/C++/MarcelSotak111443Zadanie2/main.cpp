...
/*
Meno a priezvisko: Marcel Soták
...
int numDigits(int value) {
    string meno;
    meno = to_string(value);
    int size = meno.size();

    return size; // tento riadok zmente podla zadania, je tu len kvoli kompilacii
}
/*
    int numDigits(int value)
    {
