...
public abstract class AbstractThesisService<S, T, A> implements AutoCloseable {
     ...
     */
    public abstract S createStudent(Long aisId, String name, String email, String password,int year, int term, String programme);
     ...
     */
    public abstract T createTeacher(Long aisId, String name, String email, String password, String department, String institute);
