...
import sk.stuba.fei.uim.vsa.pr2.bonus.Page;
import sk.stuba.fei.uim.vsa.pr2.bonus.Pageable;
import sk.stuba.fei.uim.vsa.pr2.bonus.PageableThesisService;
...
import static sk.stuba.fei.uim.vsa.pr2.services.ThesisServiceUtils.asDate;
import static sk.stuba.fei.uim.vsa.pr2.services.ThesisServiceUtils.asLocalDate;
...
public class ThesisService extends AbstractThesisService<Student, Teacher, Thesis> implements PageableThesisService<Student, Teacher, Thesis> {
    ...
    public Thesis createThesis(String registrationNumber, String title, String type, String description, Teacher teacher) {
        return utils.create(() -> {
            LocalDate now = LocalDate.now();
            return Thesis.builder()
                    .registrationNumber("FEI-" + new SecureRandom().nextInt(99999))
    ...
    public Student getStudentByName(String name){
        return utils.getStudentByName(name);
    }

    public Teacher getTeacherByName(String name){
        return utils.getTeacherByName(name);
    }
